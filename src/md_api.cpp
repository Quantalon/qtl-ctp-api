...
void MdApi::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField *data) {
    ...
    queue_->dispatch([&]() {
        ...
        if (has_data) {
            ...
            py_data["OpenPrice"] = adjust_price(rsp_data.OpenPrice);
            py_data["HighestPrice"] = adjust_price(rsp_data.HighestPrice);
            py_data["LowestPrice"] = adjust_price(rsp_data.LowestPrice);
            py_data["Volume"] = rsp_data.Volume;
            py_data["Turnover"] = rsp_data.Turnover;
            py_data["OpenInterest"] = rsp_data.OpenInterest;
            py_data["ClosePrice"] = adjust_price(rsp_data.ClosePrice);
            py_data["SettlementPrice"] = adjust_price(rsp_data.SettlementPrice);
            py_data["UpperLimitPrice"] = adjust_price(rsp_data.UpperLimitPrice);
            ...
            py_data["AskPrice1"] = adjust_price(rsp_data.AskPrice1);
            py_data["AskVolume1"] = rsp_data.AskVolume1;
            py_data["BidPrice2"] = adjust_price(rsp_data.BidPrice2);
            py_data["BidVolume2"] = rsp_data.BidVolume2;
            py_data["AskPrice2"] = adjust_price(rsp_data.AskPrice2);
            py_data["AskVolume2"] = rsp_data.AskVolume2;
            py_data["BidPrice3"] = adjust_price(rsp_data.BidPrice3);
            py_data["BidVolume3"] = rsp_data.BidVolume3;
            py_data["AskPrice3"] = adjust_price(rsp_data.AskPrice3);
            py_data["AskVolume3"] = rsp_data.AskVolume3;
            py_data["BidPrice4"] = adjust_price(rsp_data.BidPrice4);
            py_data["BidVolume4"] = rsp_data.BidVolume4;
            py_data["AskPrice4"] = adjust_price(rsp_data.AskPrice4);
            py_data["AskVolume4"] = rsp_data.AskVolume4;
            py_data["BidPrice5"] = adjust_price(rsp_data.BidPrice5);
